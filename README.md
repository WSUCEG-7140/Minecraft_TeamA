...
- Example in [`player.py`](https://github.com/WSUCEG-7140/Tempus_Fugit_Minecraft/blob/master/tempus_fugit_minecraft/player.py) in the `start_sprinting()` and `slow_walking_speed()` functions.
