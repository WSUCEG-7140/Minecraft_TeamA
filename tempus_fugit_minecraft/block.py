...
"""!
Issue fogleman#33 and issue#34 were created on June 19 to let players create clouds anywhere and may build their homes on clouds
issue#42 was created on June 21 that block the user to build on clouds!
@w1158mxs left a preview on June 22 in issue#42 that will use the key it was mentioned in issue#33 and issue#34 to build clouds and will let players build their homes on clouds!
while issue#80 used keys
