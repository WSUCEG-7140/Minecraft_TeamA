...
class TestBlock:
    # issue#47 issue#80 issue#33 
    def test_specified_blocks_are_breakable(self):
        blocks = [GRASS, SAND, BRICK, TREE_LEAVES, TREE_TRUNK, LIGHT_CLOUD]
    ...
    def test_specified_blocks_not_breakable(self):
        blocks = [STONE, DARK_CLOUD]

        for block in blocks:
            assert not block.is_breakable

    #issue47 #issue80 issue#33
